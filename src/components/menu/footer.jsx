...
const Footer = () => {
  return (
    <footer className="shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 rounded-none bg-black antialiased">
    <p className="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2023-2024 <a href="JavaScript:void(0) " className="hover:underline">Greenhouse.com</a>. All rights reserved.
    </p>
